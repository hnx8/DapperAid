...
namespace DapperAid
{
    ...
    public static partial class IDbTransactionExtensions
    {
        ...
        public static Task<T> SelectAsync<T>(this IDbTransaction transaction, Expression<Func<T>> keyValues, Expression<Func<T, dynamic>> targetColumns = null, int? timeout = null)
        {
            return new QueryRunner(transaction, timeout).SelectAsync(keyValues, targetColumns);
        }
        ...
        /// <typeparam name="T">テーブルにマッピングされた型</typeparam>
        /// <returns>挿入された行数</returns>
        public static Task<int> InsertAsync<T>(this IDbTransaction transaction, T data, Expression<Func<T, dynamic>> targetColumns = null, bool retrieveInsertedId = false, int? timeout = null)
        {
            return new QueryRunner(transaction, timeout).InsertAsync(data, targetColumns, retrieveInsertedId);
        }
        ...
        /// <typeparam name="T">テーブルにマッピングされた型</typeparam>
        /// <returns>挿入された行数</returns>
        public static Task<int> InsertRowsAsync<T>(this IDbTransaction transaction, IEnumerable<T> data, Expression<Func<T, dynamic>> targetColumns = null, int? timeout = null)
        {
            return new QueryRunner(transaction, timeout).InsertRowsAsync(data, targetColumns);
        }
