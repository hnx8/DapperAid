...
namespace DapperAid
{
    ...
    public static partial class IDbTransactionExtensions
    {
        ...
        public static Task<T> SelectFirstAsync<T>(this IDbTransaction transaction, Expression<Func<T, bool>>? where = null, string? otherClauses = null, int? timeout = null)
            where T : notnull
        {
            return new QueryRunner(transaction, timeout).SelectFirstAsync<T, T>(where, otherClauses);
        }
        ...
        /// <typeparam name="T">テーブルにマッピングされた型</typeparam>
        /// <returns>取得したレコード（１件）</returns>
        public static Task<T> SelectFirstAsync<T>(this IDbTransaction transaction, Expression<Func<T, bool>>? where, Expression<Func<T, dynamic>>? targetColumns, string? otherClauses = null, int? timeout = null)
            where T : notnull
        {
            return new QueryRunner(transaction, timeout).SelectFirstAsync<T>(where, targetColumns, otherClauses);
        }
        ...
        /// <typeparam name="TColumns">取得対象列にマッピングされた型</typeparam>
        /// <returns>取得したレコード（１件）</returns>
        public static Task<TColumns> SelectFirstAsync<TFrom, TColumns>(this IDbTransaction transaction, Expression<Func<TFrom, bool>>? where = null, string? otherClauses = null, int? timeout = null)
            where TFrom : notnull
            where TColumns : notnull
        {
            return new QueryRunner(transaction, timeout).SelectFirstAsync<TFrom, TColumns>(where, otherClauses);
        }
